...
_connected_components_so = tf.load_op_library(
    get_path_to_datafile("custom_ops/image/_connected_components.so"))
...
def connected_components(images,name=None):
  ...
  with tf.name_scope(name or "connected_components"):
    ...
    components = _connected_components_so.image_connected_components(images)
