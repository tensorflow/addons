...
from . import sparse_image_warp  # Need to directly import full module, not just public API
...
class SparseImageWarpTest(tf.test.TestCase):
    ...
    def testGetBoundaryLocations(self):
        ...
        locs = sparse_image_warp._get_boundary_locations(
            image_height, image_width, num_points_per_edge)
    ...
    def assertMoveSinglePixel(self, order, num_boundary_points, type_to_use):
        ...
        control_point_displacements = tf.constant(np.float32(
    ...
    def load_image(self, image_file, sess):
        image_op = tf.image.decode_png(tf.io.read_file(image_file),
    ...
    def testSmileyFace(self):
        ...
        test_data_dir = tf1.test.test_src_dir_path('contrib/image/python/'
    ...
    def testThatBackpropRuns(self):
        ...
        init_op = tf1.variables.global_variables_initializer()  # TODO: fix TF1 ref.
