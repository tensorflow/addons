...
if __name__ == "__main__":
    ...
    dense_net.compile(optimizer=tfa.optimizers.LazyAdamOptimizer(0.001),
                      loss=tf.keras.losses.SparseCategoricalCrossentropy(),
                      metrics=['accuracy'])

    # Train the network
    history = dense_net.fit(data['x_train'], data['y_train'],
                            batch_size=64,
                            epochs=10,
    ...
    results = dense_net.evaluate(data['x_test'], data['y_test'], batch_size=128)
