...
class NovoGrad(tf.keras.optimizers.Optimizer):
    ...
    def set_weights(self, weights):
        ...
        # even without amsgrad, i.e, V1 optimizer has 3x + 1 variables,
        # while V2 optimizer has 2x + 1 variables.
        # Filter vhats out for compatibility.
    ...
    def _resource_apply_dense(self, grad, var, apply_state=None):
        ...
        grad = tf.cond(
            ...
            lambda: grad + weight_decay * var, lambda: grad
        )
        grad = tf.cond(
