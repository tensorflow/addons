...
class SpectralNormalization(tf.keras.layers.Wrapper):
    ...
    >>> x = tf.constant( [[ 177,  164,  169,  165,  133,  134,  168,  174,  160,  165], [154,  146,  100,   54,   48,   19,    8,   6,
    ...
    ... 7,  186,  183,  181,   73,   50,   54], [ 70,   27,  194,  204,  195,  193,  174,   58,   39,   96]],dtype = tf.int32)
