...
# you can use "pip install tensorflow-cpu==2.10.0rc2" too if you're not testing on gpu.
pip install -e ./
```
...
```bash
python configure.py
pip install tensorflow==2.10.0rc2 -e ./ -r tools/install_deps/pytest.txt
...
Configure:
```bash
python3 -m pip install tensorflow==2.10.0rc2
