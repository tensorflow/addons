...
EXCEPTION_LIST = [
    ...
    tensorflow_addons.layers.GELU,
    tensorflow_addons.layers.Maxout,
    tensorflow_addons.layers.GroupNormalization,
    tensorflow_addons.layers.InstanceNormalization,
    tensorflow_addons.layers.CorrelationCost,
    tensorflow_addons.layers.PoincareNormalize,
    tensorflow_addons.layers.Sparsemax,
    tensorflow_addons.layers.TLU,
    ...
    tensorflow_addons.optimizers.ConditionalGradient,
    tensorflow_addons.optimizers.CyclicalLearningRate,
    tensorflow_addons.optimizers.TriangularCyclicalLearningRate,
    tensorflow_addons.optimizers.Triangular2CyclicalLearningRate,
    tensorflow_addons.optimizers.ExponentialCyclicalLearningRate,
    ...
    tensorflow_addons.optimizers.NovoGrad,
